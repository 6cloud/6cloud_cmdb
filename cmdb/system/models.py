...
class Role(models.Model):
    ...
    permission = models.ManyToManyField(Permission, related_name='role_perm', blank=True, verbose_name='角色权限')
...
class User(AbstractUser):
    ...
    role = models.ManyToManyField(Role, related_name='user_roles', blank=True, verbose_name='角色')
